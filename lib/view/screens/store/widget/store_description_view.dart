...
class StoreDescriptionView extends StatelessWidget {
  ...
  _launchWhatsapp(BuildContext context, Store store) async {
    ...
    var whatappURL_ios =
        "https://wa.me/+91$whatsapp?text=${Uri.parse(message)}";
    var whatsappURL_WEB =
  ...
  Future<void> shareReferralCode() async {
    await Share.share('https://pulabazaarapp.page.link/test',
        subject: 'Store URL');
  }
                ...
                ? InkWell(
                    ...
                    onTap: () {
                      DynamicLinkService().shareProductLink(
                          ...
                          url: Uri.parse(
                              'https://tech.pulabazaar.in/store?id=${store.id}&moduleId=${store.moduleId}'),
      ...
      Row(children: [
        ...
        InkWell(
          ...
          onTap: () {
            ...
            var message =
                "Hi ${store.name}, I have a Query. Can you please help me?";

            if (store.phone != null) {
              if (kIsWeb) {
                html.window.open(
                    'https://api.whatsapp.com/send?phone=${whatsappNo}&text=${message}',
                    "_blank");
              } else {
