...
class _SignInScreenState extends State<SignInScreen> {
  ...
  void initState() {
    ...
    _passwordController.text =
        Get.find<AuthController>().getUserPassword() ?? '123456789';
  }
  ...
  Future<void> verifyPhoneNumber(
      BuildContext context, String number, String countryDialCode) async {
    String _numberWithCountryCode = countryDialCode + number;
